...
describe('Calificación sobrevalorada de una cita.', () => {
    ...
    it('Debe ser rechazada', async () => {
        ...
        const dto: RateAppointmentApplicationServiceDto = { id: appointment.Id.Value, patientId: patient.Id.Value, rating: 6 };
