...
| Implementación de una prueba que valida que se actualice la descripción de un registro medico e implementación de una prueba que valida que un doctor no pueda crear un registro medico en una cita en la que el no participó | https://github.com/The-Hackers-UCAB/MyOnlineDoctor-Backend/pull/49 |
